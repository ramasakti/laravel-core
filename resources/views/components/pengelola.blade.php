<div class="form-group">
    <label class="mt-2">Nama Pengelola / PIC</label>
    @if ($require == 1)
        <span class="text-danger">*</span>
    @endif
    <div class="form-button">
        <input type="text" class="form-control step-{{ $step }}" name="{{ $component }}" onchange="changeStatus(this.id)" 
        id="{{ $component }}" {{ ($require == 1) ? 'required' : '' }}>
    </div>
</div>
<script>
    (function() {
